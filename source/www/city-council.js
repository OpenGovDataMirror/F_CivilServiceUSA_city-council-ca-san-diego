  ...
  $.getJSON('city-council/data/city-council-data.json', function( data ) {
    ...
    $.each( data, function( key, val ) {
      ...
      var jsonld = {
        ...
        "url": "https://civilserviceusa.github.io/city-council-ca-san-diego/",
        "sameAs": []
      };
      ...
      jsonld.image = 'https://civilserviceusa.github.io/city-council-ca-san-diego/images/headshots/512x512/' + val.name_slug + '.jpg';
      jsonld.jobTitle = toTitleCase(val.title) + ' of San Diego City Council';
